  ...
  async function verifyRequestDApp() {
    ...
    return (
        <div className="text-center">
          ...
          <br/>
          <button onClick={verifyRequestDApp} type="button" className="btn btn-primary me-md-2" data-bs-toggle="button" autoComplete="off">Provide ZK-Proof to DApp for Access</button>
          <br/> <br/><br/>
